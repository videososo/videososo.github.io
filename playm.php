...
<div class="html5play">
<iframe src="playm/index.php?url=<?php echo $_GET['url'];?>" marginwidth="0" marginheight="0" border="0" scrolling="no" frameborder="0" topmargin="0" width="100%" height="600px"></iframe>

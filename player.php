...
<div class="html5play">
<iframe src="player/index.html?vurl=<?php echo $_GET['url'];?>" marginwidth="0" marginheight="0" border="0" scrolling="no" frameborder="0" topmargin="0" width="100%" height="600px"></iframe>
...
<a href="player/index.html?vurl=<?php echo $_GET['url'];?>" class="am-btn am-btn-default lipbtn">播放中</a>
